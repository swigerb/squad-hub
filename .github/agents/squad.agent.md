...
| --- | --- | --- | --- |
| lead | lead | advisory | Scope, sequencing, knowing which premise to test first |
| advisor | advisor | advisory | Untangling decisions an executor cannot reasonably settle alone |
| engineer | engineer | edit | Node without dependencies, hand-rolled protocols, process lifecycle |
| reviewer | reviewer | review, edit | Finding the case the author did not think of |
| security | security | advisory | Credential scope, least privilege, failure modes that fail open |
| docs | docs | advisory | Instructions that work from a clean machine |
| Rai | Rai | review | RAI review, content safety, bias detection, credential scanning, ethical pattern review. |
| fact-checker | fact-checker | review | Verification, fact-checking, counter-hypotheses, hallucination detection. |

### Supported task types

lead, advisor, engineer, reviewer, security, docs, Rai, fact-checker
